...
export const PROVIDERS = {
    openrouter: {
        ...
        notes: "Tier 1 — best free model selection. Hard 50 RPD + 20 RPM across the entire account. Spend on hardest tasks only.",
    },
    inceptionlabs: {
        id: "inceptionlabs",
        name: "InceptionLabs",
        ...
        notes: "Tier 2 — 100M one-time token budget shared across models. Output TPM (100K) is the real bottleneck. Drains in ~1.5h at full burn.",
    },
    tokenreply: {
        id: "tokenreply",
        name: "TokenReply",
        ...
        notes: "Tier 2 — 44 free models but 3 RPM cap across ALL models at any given time. Varying uptime.",
    },
    requesty: {
        id: "requesty",
        name: "Requesty.AI",
    ...
    pollinations: {
        ...
        limits: { scope: "model" },
        notes: "Tier 3 — all models unlimited (no daily cap), per-model RPM limits. Round-robin across models to multiply throughput.",
    },
    "pollinations-noauth": {
        ...
        limits: { scope: "model" },
        keyless: true,
        notes: "Tier 4 — GET text.pollinations.ai/{prompt}, no API key, always-on last resort. No tools, no streaming.",
    },
    mock: {
        id: "mock",
        name: "Mock",
